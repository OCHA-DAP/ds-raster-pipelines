...
class TestERA5Pipeline:
    ...
    def test_generate_raw_filename(self, pipeline):
        assert (
    ...
    def test_generate_processed_filename(self, pipeline):
        assert (
    ...
    def test_run_pipeline_full(self, mock_process_data, mock_get_raw_data, pipeline):
    ...
    @patch("src.pipelines.era5_pipeline.ERA5Pipeline.get_raw_data")
    @patch("src.pipelines.era5_pipeline.ERA5Pipeline.process_data")
    def test_run_pipeline_update(self, mock_process_data, mock_get_raw_data, pipeline):
